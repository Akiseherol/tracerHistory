...
template<class Type>
void Foam::functionObjects::tracerHistory::writePointValue
(
    Ostream& os,
    const vector& pt,
    const Type& val
...
template<class Type>
void Foam::functionObjects::tracerHistory::writeList
(
    Ostream& os,
...
template<class Type>
void Foam::functionObjects::tracerHistory::writeListParallel
(
    Ostream& os,
    const vectorField& points,
    const List<Type>& field
...
template<class Type>
bool Foam::functionObjects::tracerHistory::writeField
(
